...
var FinalizeOAuthInputSet = function() {
    FinalizeOAuthInputSet.super_.call(this);
        /*
        Set the value of the AccountName input for this Choreo. ((optional, string) (Deprecated) This input variable is no longer necessary and will be removed soon.)
        */
        ...
        /*
        Set the value of the AppKeyName input for this Choreo. ((optional, string) (Deprecated) This input variable is no longer necessary and will be removed soon.)
        */
        ...
        /*
        Set the value of the AppKeyValue input for this Choreo. ((optional, string) (Deprecated) This input variable is no longer necessary and will be removed soon.)
        */
